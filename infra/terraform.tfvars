...
nsg = {
  web_nsg = {
    ...
    securahuly_rules = {
      allow_http = {
        securahuly_rule_name         = "allow-http"
        priorahuly                   = 100
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "Tcp"
      ...
      # allow_ssh = {
      #   securahuly_rule_name         = "allow-ssh"
      #   priorahuly                   = 101
      #   direction                  = "Inbound"
      #   access                     = "Allow"
      #   protocol                   = "Tcp"
...
# sql_servers = {
#   sqlserver1 = {
#     sqlservername         = "rkqlserver1q"
#     rg_name               = "rk-rg5"
#     location              = "North Europe"
#     version               = "12.0"
#     server_login_username = "server"
#     server_login_password = "Rahul@12345"

#     public_network_access_enabled = false
#   }
#   sqlserver2 = {
#     sqlservername         = "rkqlserver2q"
#     rg_name               = "rk-rg5"
#     location              = "North Europe"
#     version               = "12.0"
#     server_login_username = "server"
...
sql_databases = {
  db1 = {
    name           = "appdb"
    server_name    = "rkqlserver1123"
    resource_group = "rk-rg5"
    sku_name       = "S0"
  }
  db2 = {
    name           = "analyticsdb"
...
azurerm_lb_rb = {
  lb1 = {
    rg_name  = "rk-rg5"
    pip_name = "loadbalancerpip"
    lb_name  = "rahul-loadbalancer"
    location = "North Europe"
    sku      = "Standard"
    frontend_ip_config = [
      {
        name = "rahul-frontend-ipconfig"
      }
    ]
  }
}
...
backend_ap_rb = {
  bap1 = {
    lb_name           = "rahul-loadbalancer"
    rg_name           = "rk-rg5"
    backend_pool_name = "rahul-backend-pool"
  }
}
...
nic_bp_association = {
  firstassociation = {
    ...
    lb_name                   = "rahul-loadbalancer"
    rg_name                   = "rk-rg5"
    backend_address_pool_name = "rahul-backend-pool"
...
lb_rule = {
  lb1 = {
    lb_name                         = "rahul-loadbalancer"
    rg_name                         = "rk-rg5"
    backend_address_pool_db_ka_name = "rahul-backend-pool"
    lb_rule_name                    = "rahul-lb-rule"
    protocol                        = "Tcp"
    frontend_port                   = 80
    backend_port                    = 80
    frontend_ip_configuration_name  = "rahul-frontend-ipconfig"
    probe_name                      = "rahul-health-probe"
  }
}
